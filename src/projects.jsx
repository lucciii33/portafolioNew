  ...
  return (
    <>
      <div  className='projects-main' id="projects-main">
        ...
        <WorkCard title={"Elana"} description={"A provider that help user conect with doctor for pelvic care"} time={"12 month"}frontend={"Next.js, ChakraUI, Redux"} backend={"Express.js, node.js, mongoDB"}  mockup1={mockup3} link={"https://staging-site-elana.netlify.app"} scrollPosition={scrollPosition}  />
        </div>
      </div>
    </>
  );
