  ...
  return (
    <>
      ...
      <img src={coffee} className="coffee-img"></img>
        <h3 className="pa" ref={(el) => (boxesRef.current[0] = el)}>Let's chat.</h3>
        <p className="text1 pa" ref={(el) => (boxesRef.current[1] = el)}>want to see more work?<br  className="d-mobile"/> talk about code?<br/>
